<?php /* Smarty version Smarty-3.0.9, created on 2015-11-25 17:06:44
         compiled from "C:/wamp/www/encuestando/glight/templates\header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:96765655dc946db117-03660077%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '96765655dc946db117-03660077',
  'function' => 
  array (
  ),
...
suscribir_empresa.php">Suscribir empresa</a></li>
                            <li><a href="<?php echo $_smarty_tpl->getVariable('gvar')->value['l_global'];?>
crear_encuesta.php">Crear encuesta</a></li>
                        ...
                        <?php if ($_SESSION['persona']['rol']=="usuario"){?>
                            <li><a href="<?php echo $_smarty_tpl->getVariable('gvar')->value['l_global'];?>
editar_usuario.php">Editar usuario</a></li>
                            <li><a href="<?php echo $_smarty_tpl->getVariable('gvar')->value['l_global'];?>
